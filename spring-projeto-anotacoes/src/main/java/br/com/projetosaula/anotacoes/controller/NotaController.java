...
public class NotaController
{
	...
	@DeleteMapping("/{id}")
	public ResponseEntity<Boolean> deleteNota(@PathVariable Integer id) throws Exception
	{
		return new ResponseEntity<>(service.delete(id), HttpStatus.OK);
	}
	
	@PutMapping
	public ResponseEntity<NotaDTO> updateNota(@RequestBody NotaDTO nota) throws Exception
	{
